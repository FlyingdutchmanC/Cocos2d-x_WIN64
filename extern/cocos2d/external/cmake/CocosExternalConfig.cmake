...
elseif(WINDOWS)
    if(X64)
        ...
        if(EXISTS ${_path_prefix}/win64/${_type_folder}-lib)
            set(platform_spec_path win64/${_type_folder}-lib)
        elseif(EXISTS ${_path_prefix}win64/${_type_folder})
            set(platform_spec_path win64/${_type_folder})
        else()
